...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Paper}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PaperResource {
     ...
     */
    @PostMapping("/papers")
    public ResponseEntity<Paper> createPaper(@RequestBody Paper paper) throws URISyntaxException {
     ...
     */
    @PutMapping("/papers")
    public ResponseEntity<Paper> updatePaper(@RequestBody Paper paper) throws URISyntaxException {
